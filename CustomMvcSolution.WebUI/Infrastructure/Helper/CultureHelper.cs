...
namespace CustomMvcSolution.WebUI.Infrastructure.Helper
{
    public static class CultureHelper
    {
        ...
        static readonly SettingProvider Sp = new SettingProvider();
        private static readonly string defaultLanguage = Sp.GetSetting<string>("DefaultLanguage");

        // Include ONLY cultures you are implementing
        private static readonly IList<string> Cultures = new List<string> {
            defaultLanguage,  // first culture is the DEFAULT
