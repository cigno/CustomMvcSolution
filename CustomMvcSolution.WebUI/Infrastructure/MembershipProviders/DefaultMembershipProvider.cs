...
namespace CustomMvcSolution.WebUI.Infrastructure.MembershipProviders
{
    public class DefaultMembershipProvider : MembershipProvider
    {
        ...
        public override bool ValidateUser(string username, string password)
        {
            ...
            Password memberPassword = _context.Passwords.FirstOrDefault(p => p.Member.UserName == username);

            if (member != null && memberPassword != null)
            {
                
                string expectedPassword = PasswordHelper.CreatePasswordHash(password, memberPassword.Salt);
                string actualPassword = memberPassword.Hash;
